...
public class Cliente extends AuditModel {
	...
	@ApiModelProperty(notes="Nombres del cliente", position=1)
    @NotNull
    @Column(nullable=false)
    @Size(max = 200, message="Nombre debe ser de menos de 200 caracteres")
    private String nombres;
	
	@ApiModelProperty(notes="Apellidos del cliente", position=2)
    @NotNull
    @Column(nullable=false)
    @Size(max = 200, message="Apellidos debe ser de menos de 200 caracteres")
    private String apellidos;
	
	@ApiModelProperty(notes="Teléfono de cliente", position=3)
    @NotNull
